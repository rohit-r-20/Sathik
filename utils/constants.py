...
MOCK_SUBCATEGORIES = [
    ...
    {'name': 'Angle Grinders', 'slug': 'angle-grinders', 'category_slug': 'power-tools', 'business_slug': 'plumbing', 'icon': '⚙️', 'order': 1},
    {'name': 'Drilling Machines', 'slug': 'drilling-machines', 'category_slug': 'power-tools', 'business_slug': 'plumbing', 'icon': '🔩', 'order': 2},
    {'name': 'Demolition Hammers', 'slug': 'demolition-hammers', 'category_slug': 'power-tools', 'business_slug': 'plumbing', 'icon': '🔨', 'order': 3},
    {'name': 'Air Blowers', 'slug': 'air-blowers', 'category_slug': 'power-tools', 'business_slug': 'plumbing', 'icon': '💨', 'order': 4},
    {'name': '14-Inch Cut-Off Machines', 'slug': 'cut-off-machines', 'category_slug': 'power-tools', 'business_slug': 'plumbing', 'icon': '🪚', 'order': 5}
]
